...
//
// Provides source-level mapping for violations found in lifted code.
//
...
mod tests {
    ...
    fn parse_binary_metadata(binary: &[u8]) -> BinaryMetadata {
    ...
    fn detect_format(binary: &[u8]) -> BinaryFormat {
        ...
        match &binary[..4] {
            ...
            | [0xfe, 0xed, 0xfa, 0xcf]
            | [0xcf, 0xfa, 0xed, 0xfe]
            | [0xce, 0xfa, 0xed, 0xfe] => BinaryFormat::MachO,
