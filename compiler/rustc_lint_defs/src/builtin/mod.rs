...
// tRust: split from single builtin.rs into submodules for file size reduction.
// All lint declarations are in alphabetical submodules and re-exported here
// so external callers (rustc_lint_defs::builtin::LINT_NAME) are unaffected.
