...
pub struct Config {
    ...
    ///
    /// For example:
    /// - `./rust/build/x86_64-unknown-linux-gnu/stage1/bin/lib`
    ...
    ///
    /// For example:
    /// - `./rust/build/x86_64-unknown-linux-gnu/stage1/lib/rustlib/i686-unknown-linux-gnu/lib`
    ///
    ...
    ///
    /// For example:
    /// - `./rust/build/x86_64-unknown-linux-gnu/stage1-tools-bin/cargo`
    ///
    ...
    ///
    /// For example:
    /// - `./rust/build/x86_64-unknown-linux-gnu/stage0/bin/rustc`
    ...
    /// - `./rust/build/x86_64-unknown-linux-gnu/test/coverage`
...
pub(crate) struct TestPaths {
    ...
    ///
    /// For example:
    /// - `file`: `./rust/tests/ui/warnings/hello-world.rs`
