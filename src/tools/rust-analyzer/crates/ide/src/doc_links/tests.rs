...
"#,
        ...
        Some(expect![[r#"file://./project/doc/foo/index.html"#]]),
        Some("/sysroot"),
    );
}
...
"#,
        ...
        Some(expect![[r#"file://./project/doc/foo/struct.Foo.html"#]]),
        Some("/sysroot"),
    );
}
...
"#,
        Some(r"./project"),
        Some(expect![[r#"https://docs.rs/foo/*/foo/struct.Foo.html"#]]),
        Some(expect![[r#"file:///C:./project/doc/foo/struct.Foo.html"#]]),
        Some("/sysroot"),
    );
}
...
fn main() {
    foo::my_m$0acro!();
        ...
        Some(expect![[r#"file://./project/doc/foo/macro.my_macro.html"#]]),
        Some("/sysroot"),
    );
}
