...
```shell
$ cargo run --release
   Compiling rust-cfi-1 v0.1.0 (./rust-cfi-1)
...
```shell
$ cargo run --release
   Compiling rust-cfi-2 v0.1.0 (./rust-cfi-2)
...
```shell
$ cargo run --release
   Compiling rust-cfi-3 v0.1.0 (./rust-cfi-3)
...
RUSTFLAGS="-L./target/release -Clinker=clang -Clink-arg=-fuse-ld=lld" cargo build --release
   Compiling rust-cfi-4 v0.1.0 (./rust-cfi-4)
