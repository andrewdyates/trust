...
The primary debug info format for `*-msvc` targets. PDB is a  container format created by
...
Due to its  nature, it is very difficult to find information about PDB and CodeView. Many
...
> NOTE: CDB is a  debugger created by Microsoft. The underlying engine also powers
