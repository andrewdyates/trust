...
stack backtrace:
   (~~~~ LINES REMOVED BY ME FOR BREVITY ~~~~)
             at ./rust/compiler/rustc_typeck/src/check/cast.rs:110
   7: rustc_typeck::check::cast::CastCheck::check
             at ./rust/compiler/rustc_typeck/src/check/cast.rs:572
             at ./rust/compiler/rustc_typeck/src/check/cast.rs:460
             at ./rust/compiler/rustc_typeck/src/check/cast.rs:370
   (~~~~ LINES REMOVED BY ME FOR BREVITY ~~~~)
  33: rustc_driver::driver::compile_input
             at ./rust/compiler/rustc_driver/src/driver.rs:1010
             at ./rust/compiler/rustc_driver/src/driver.rs:212
  34: rustc_driver::run_compiler
             at ./rust/compiler/rustc_driver/src/lib.rs:253
```
...
./rust/compiler/rustc_errors/src/lib.rs:411:12
...
stack backtrace:
  (~~~ IRRELEVANT PART OF BACKTRACE REMOVED BY ME ~~~)
   7: rustc::traits::error_reporting::<impl rustc::infer::InferCtxt<'a, 'tcx>>
             ...
             at ./rust/compiler/rustc_middle/src/traits/error_reporting.rs:823
   8: rustc::traits::error_reporting::<impl rustc::infer::InferCtxt<'a, 'tcx>>
             ::report_fulfillment_errors
             at ./rust/compiler/rustc_middle/src/traits/error_reporting.rs:160
             at ./rust/compiler/rustc_middle/src/traits/error_reporting.rs:112
   9: rustc_typeck::check::FnCtxt::select_obligations_where_possible
             at ./rust/compiler/rustc_typeck/src/check/mod.rs:2192
  (~~~ IRRELEVANT PART OF BACKTRACE REMOVED BY ME ~~~)
