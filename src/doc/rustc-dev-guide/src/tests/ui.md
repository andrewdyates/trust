...
There are several directives which will change how compiletest
...
The `error-pattern` directive can be used for runtime messages which don't
...
Just add one of the following directives:
